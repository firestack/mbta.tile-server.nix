...
# From https://github.com/gravitystorm/openstreetmap-carto/blob/master/scripts/generate_shields.py
...
def main():
    ...
    config['base']['padding_x'] = 2 #4
    config['base']['padding_y'] = 2 #2
    ...
    config['global']['types'] = ['motorway', 'exit']
    config['global']['max_width'] = 12
    config['global']['max_height'] = 4
    config['global']['output_dir'] = './etc/skate-style/img/shields/' # specified relative to the script location

    config['global']['additional_sizes'] = ['base']

    # specific values overwrite config['base'] ones
    config['motorway'] = {'fill': '#FFE1C6', 'stroke_fill': '#EFC59E'}
    config['exit'] = {'fill': '#1B7979', 'stroke_fill': '#FFFFFF'}
